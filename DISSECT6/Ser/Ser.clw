...
Resource3=IDR_SERTYPE
Resource8=IDR_MAINFRAME (English (U.S.))
Resource9=IDR_SERTYPE (English (U.S.))
Resource10=IDD_ABOUTBOX (English (U.S.))

[CLS:CSerApp]
Type=0
HeaderFile=Ser.h
ImplementationFile=Ser.cpp
Filter=N

[CLS:CSerDoc]
Type=0
HeaderFile=SerDoc.h
ImplementationFile=SerDoc.cpp
Filter=N

[CLS:CSerView]
Type=0
HeaderFile=SerView.h
ImplementationFile=SerView.cpp
Filter=C
