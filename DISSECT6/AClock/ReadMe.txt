========================================================================
		ActiveX Control DLL : ACLOCK
========================================================================

ControlWizard has created this project for your ACLOCK ActiveX Control
...
that make up your ACLOCK ActiveX Control DLL.
...
AClockCtl.h
	This file contains the declaration of the CAClockCtrl C++ class.

AClockCtl.cpp
	This file contains the implementation of the CAClockCtrl C++ class.

AClockPpg.h
	This file contains the declaration of the CAClockPropPage C++ class.

AClockPpg.cpp
	This file contains the implementation of the CAClockPropPage C++ class.

AClockCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CAClockCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file AClock.rc.
