...
BOOL CChildFrame::OnCreateClient(LPCREATESTRUCT /*lpcs*/, CCreateContext* pContext)
{
	...
	if (!m_wndSplitter.CreateView(0, 0, RUNTIME_CLASS(CLeftView), CSize(100, 100), pContext) ||
		!m_wndSplitter.CreateView(0, 1, RUNTIME_CLASS(CExp4View), CSize(100, 100), pContext))
	{
...
CExp4View* CChildFrame::GetRightPane()
{
	CWnd* pWnd = m_wndSplitter.GetPane(0, 1);
	CExp4View* pView = DYNAMIC_DOWNCAST(CExp4View, pWnd);
	return pView;
}
...
void CChildFrame::OnViewStyle(UINT nCommandID)
{
	...
	// if the right-hand pane has been created and is a CExp4View, process the menu commands...
	if (pView != NULL)
	{
		int nStyle = -1;
